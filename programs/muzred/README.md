# Музыкальный редактор (advert)

All that survives of ФМГ's music editor (Воронеж 1994): its animated advertisement `ZASTM.SAV` (needs a `REKL.HLP` of melody integers ending in 0 — the original is lost, a re-created one ships beside it as REKL.HLP).
