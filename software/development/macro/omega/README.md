# MACRO-11 and LINK: the ОМЕГА kits

Disks 059 (the omega-games disk of 1991, whose monitor is `systems/omega/`), 062, 063, 064 and 172 - ОМЕГА SJ(S) V05.04 kits of НИПП «Омега», Львов, with Russian utility messages; 064 carries a later LINK (V08.04) and an older MACRO (V05.01b).
