...
|---|---|---|
| `HANOJ.SAV` | The Towers of Hanoi as the ОСА disk 058 carries it - the text in KOI-7 upper case (Cyrillic on a РУС terminal)  (on 058) | `RUN HANOJ` |
| `KOSMOS.SAV` | KOSMOS as 058 and 066 carry it - the same program with its text in the other letter case (case-bit flips)  (on 058, 066) | bare prompt, no answer to a bogus file name |
