...
of `../software/`, of the builds its original disks carried.  The disks
...
| `omega2/` | ОМЕГА SJ(S) V05.04 | `RT11SJ.SYS` | `b27e827` | `2c1f616` | vvv104 `disk3` (also `PAPER`, `h0`) |
...
emulator repository's `rt11_devel/projects/omega/`.
...
handler made for its sysgen (see `../software/system/handlers/README.md`).
